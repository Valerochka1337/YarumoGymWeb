...
1. Прогнать backend suite с Docker/PostgreSQL, проверить Android совместимость. Развернуть backend с `WEB_ORIGIN=https://app.valerochkagym.tech` и web OAuth audience.
